            ...
            %{--$("#forgetPasswordForm").validate({--}%
                %{--rules: {--}%
                    %{--recoveryEmail: {--}%
                        ...
                        %{--required: true,--}%
                        %{--email: true,--}%
                        %{--remote: "${createLink(controller: 'user',action: 'isEmailExist')}"--}%
                    %{--}--}%
                %{--},--}%
                %{--messages: {--}%
                    %{--recoveryEmail: {--}%
    ...
    <div class="panel panel-primary forgot-pass">
        ...
        <div class="panel-body">
            <g:form class="form-box" name="forgetPasswordForm" >
                ...
                <br>
                <g:actionSubmit controller="login" name="button" value="Submit" action="forgetPassword" style="width: 75%; margin-left: 10%;"
                                class=" btn form-btn"/>
                <br><br>
